...
export const NL: Record<string, string> = {
  ...
  /* ---- CV dossier overlay ----------------------------------------- */
  'nav.cv': 'CV',
  'hero.cta.cv': 'Bekijk CV',
  'cv.bar': 'Curriculum Vitae — Kain Mckancy La Reine',
  'cv.download': 'Download PDF',
  'cv.boot.eyebrow': 'Dossier — Kain Mckancy La Reine',
  'cv.boot.cancel': 'annuleren',
  'cv.boot.profile': 'Profiel voorbereiden',
  'cv.boot.type': 'Typografie laden',
  'cv.boot.sections': 'Secties samenstellen',
  'cv.boot.verify': 'Document verifiëren',
  'cv.boot.assemble': 'Dossier opbouwen',
  'cv.boot.ready': 'Klaar',
  'cv.boot.restore': 'Dossier herstellen',
  'cv.boot.note.nodoc': 'Document niet beschikbaar — dossier opent zonder download',
  'cv.boot.doc.size': 'PDF · {size}',
  'cv.close': 'CV sluiten',
  'cv.index.label': 'CV-onderdelen',
  'cv.idx.profile': 'Profiel',
  'cv.idx.path': 'Traject',
  'cv.idx.skills': 'Skills',
  'cv.idx.certs': 'Certificaten',
  'cv.idx.extra': 'Talen',
  'cv.photo.alt': 'Portret van Kain Mckancy La Reine',
  'cv.eyebrow': 'Dossier — Curriculum Vitae',
  'cv.lede':
    'Creative developer uit Almere, werkzaam vanuit Amsterdam. Vier jaar school en studiowerk achter de rug — van media vormgeving op het Arte College tot de volledige software-opleiding bij Bit Academy — plus een jaar front-end in productie bij Grippr. Ik bouw filmische, motion-gedreven interfaces in React, TypeScript en GSAP.',
  'cv.fact.email': 'E-mail',
  'cv.fact.phone': 'Telefoon',
  'cv.fact.based': 'Woonplaats',
  'cv.fact.born': 'Geboren',
  'cv.fact.born.v': '25 februari 2004',
  'cv.fact.site': 'Site',
  'cv.stat.years': 'Jaar bouwen',
  'cv.stat.projects': 'Live klantsites',
  'cv.stat.certs': 'Certificaten',
  'cv.stat.stack': 'Stack-tools',
  'cv.path.title': 'Opleiding <span class="it">&amp; ervaring.</span>',
  'cv.tag.education': 'Opleiding',
  'cv.tag.work': 'Werkervaring',
  'cv.path.bit.role': 'Software-Developer',
  'cv.path.bit.copy':
    'Volledige software-opleiding: eerst PHP en databases, daarna JavaScript, React en moderne front-end architectuur — elke module beoordeeld op opgeleverde, werkende projecten in plaats van tentamens.',
  'cv.path.grippr.role': 'Junior Software-Engineer',
  'cv.path.grippr.copy':
    'Front-end werk in een klein productteam: React-componenten bouwen en onderhouden, koppelen aan de API, en ontwerpen van Figma naar responsieve productieschermen brengen.',
  'cv.path.arte.role': 'Media Vormgeving',
  'cv.path.arte.copy':
    'Hier komt de visuele helft vandaan — compositie, typografie, kleur en motion, vier jaar lang, ruim voor de eerste regel code.',
  'cv.chip.artdirection': 'Art direction',
  'cv.chip.typography': 'Typografie',
  'cv.chip.motion': 'Motion',
  'cv.skills.title': 'De stack, <span class="it">gemeten.</span>',
  'cv.skill.responsive': 'Responsive design',
  'cv.certs.title': 'Behaalde <span class="it">certificaten.</span>',
  'cv.cert.d1': 'mrt 2023',
  'cv.cert.d2': 'sep 2022',
  'cv.cert.d3': 'mrt 2022',
  'cv.cert.d4': 'feb 2022',
  'cv.cert.d5': 'nov 2021',
  'cv.extra.title': 'Talen <span class="it">&amp; interesses.</span>',
  'cv.extra.languages': 'Talen',
  'cv.extra.interests': 'Interesses',
  'cv.lang.nl': 'Nederlands',
  'cv.lang.nl.lvl': 'Moedertaal',
  'cv.lang.en': 'Engels',
  'cv.lang.en.lvl': 'Vloeiend',
  'cv.int.programming': 'Programmeren',
  'cv.int.webdesign': 'Webdesign',
  'cv.int.gaming': 'Gaming',
  'cv.outro': 'Liever de papieren versie, of het hele verhaal in een gesprek?',
  'cv.outro.contact': 'Neem contact op',
  'cv.end': 'Einde dossier — KMLR 2026',
